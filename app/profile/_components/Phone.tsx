...
import MobileLink from "../../_components/MobileLink";

import { platformColours } from "@/app/_components/PlatformIcons";
            ...
            <div className="flex flex-col gap-3 relative">
              ...
              {email && (
                <p
                  ...
                  } mt-0  whitespace-nowrap text-ellipsis overflow-hidden text-center`}
                >
                  {email}
                </p>
              )}
